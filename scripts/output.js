...
/**
 * Forked version of `generate` above; provides the new fancy UI experience and
 * support for the 'sorch' endpoint.  The intent is that
 */
function generateFancy(content, opt)
{
  let title = opt.title || "mozsearch";
  let tree = opt.tree;
  let shouldAutofocusQuery = opt.shouldAutofocusQuery || false;
...
<div id="scrolling">
  ...
  <script src="/static/js/code-highlighter.js"></script>
  <script src="/ui/searchfox-ui.bundle.js"></script>
</div>
</body>
</html>
`;
